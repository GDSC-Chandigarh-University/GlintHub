            ...
            <div id="glinthubSidebar">
                <div id="sidebar-mid">
                    ...
                    <div className="sidebar-mid-option">
                        ...
                        <NavLink to={`${url}/addApp`} activeClassName="is-active" >Add App</NavLink>
                    </div>
                    <div className="sidebar-mid-option">
                        <img className="sidebar-icon" src={DraftedSvg} />
                        {draftedProjects.length > 0 ? <NavLink to={`${url}/draftedApp`} activeClassName="is-active">Drafted App</NavLink> : <NavLink name="Drafted" to="" onClick={this.handleClick}>Drafted App</NavLink>}
                    </div>
                    <div className="sidebar-mid-option">
                        <img className="sidebar-icon" src={PublishedSvg} />
                        {publishedProjects.length > 0 ? <NavLink to={`${url}/publishedApp`} activeClassName="is-active">Published App</NavLink> : <NavLink name="Published" to="" onClick={this.handleClick}>Published App</NavLink>}
                    </div>
                    <div className="sidebar-mid-option">
